...
This example demonstrates linear actuator fault detection and classification using an AI model on the MSPM0G3519 microcontroller. The system classifies sensor data from a linear actuator into one of four categories: Normal, Spalling, Lack of Lubrication, or Backlash. The classification result is indicated by toggling onboard LEDs.
...
2. **Operation**
   ...
   - The model performs inference and classifies the input into one of four fault categories.
...
- **AI Inference**: Runs a pre-trained 5-layer CNN model using TVM runtime.
