...
This example demonstrates an ECG (Electrocardiogram) classification application using an AI model on MSPM0G3519 microcontroller. The system collects ECG data from an AFE1594 analog front-end, processes the signal, and performs inference using a pre-trained neural network model. The detected ECG class is indicated by toggling onboard LEDs.
...
MSPM0 LaunchPad, please visit the [LP-MSPM0G3519 User's Guide](https://www.ti.com/lit/slav947).

## Hardware requirements

1. MSPM0G3519 microcontroller
