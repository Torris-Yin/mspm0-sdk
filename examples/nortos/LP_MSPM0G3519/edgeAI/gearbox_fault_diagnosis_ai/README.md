...
This example demonstrates gearbox fault detection using an AI model on the MSPM0G3519 microcontroller. The system classifies vibration data from a gearbox into one of two categories: Healthy or Broken Tooth condition. The classification result is indicated by toggling onboard LEDs.
