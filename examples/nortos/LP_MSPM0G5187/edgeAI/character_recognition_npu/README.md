...
2. **Operation**
   - On startup, the application initializes UART and TinyEngine™ NPU.
   - The host GUI sends a 28x28 pixel grayscale image over UART.
   - The application performs inference using the CNN model with hardware acceleration.
